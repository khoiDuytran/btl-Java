...
public class PanelGame extends JComponent {
    ...
    private void drawGame() {
        ...
        if(!player.isAlive()) {
            ...
            g2.setFont(getFont().deriveFont(Font.BOLD, 50f));  // KÍCH CỠ TRÊN SCREEN
            ...
            g2.drawString(text, (int) x, (int) y + fm.getAscent());  // VỊ TRÍ TRÊN SCREEN
            g2.setFont(getFont().deriveFont(Font.BOLD, 20f));   // KÍCH THƯỚC
            ...
            g2.drawString(textKey, (int) x, (int) y + fm.getAscent() + 50); // VỊ TRÍ TRÊN SCREEN
        }
    }
    private void render() {
